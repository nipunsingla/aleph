        ...
        return (
            <div className='bg-light' style={{
                ...
                <ul className="list-group border-0 bg-light">
                    <li className="list-group-item border-0 bg-light"><svg class="bi bi-bell" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
